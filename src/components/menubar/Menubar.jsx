...
const Menubar = () => {
  ...
  return (
    <Flex className="flex-col justify-end xl:justify-between fixed xl:w-[186px] z-[9999] bottom-10 xl:top-0 text-white xl:h-[95vh] xl:bg-primary bg-primary/80 backdrop-blur-lg mt-[35px] py-[30px]  xl:pt-[35px] xl:pb-[47px] ml-[32px] rounded-[20px]">
...
{ show ? <RxCross2 onClick={()=>setShow(false)} className='text-[34px] mx-6 xl:hidden' /> : <IoMenu onClick={()=>setShow(true)} className='text-[24px] mx-6 xl:hidden' />  }
    </Flex>
  )
}
