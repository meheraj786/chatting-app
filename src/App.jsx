...
<Flex>
  <Flex className="left flex-col  items-end justify-center  font-primary p-10 xl:p-0 xl:w-[55%] xl:pr-[169px]">
    ...
    <input type="text" onChange={emailHandler} id="floating_outlined" className="block px-[26px] py-[26px] xl:w-[368px] text-xl text-secondary font-semibold bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-0 focus:border-secondary/30 peer" placeholder=" " />
...
<button onClick={submitHandler} className='xl:w-[368px] w-full cursor-pointer py-5 bg-primary text-white font-semibold mt-[51px] mb-[35px] rounded-[86px] text-xl'>Sign Up</button>
